        ...
        <View style={styles.content}>
          <View style={styles.contentHeader}>
            <View style={styles.contentHeaderLeft}>
              <Image
                ...
                source={{ uri: "https://i.ibb.co/wWJRJ4q/IMG-20201130-005131.jpg" }}
              />
              <Text style={styles.contentHeaderLeftText}>mateusnasciment0</Text>
            </View>
            <Points />
          </View>
          ...
          <View style={styles.contentFooter}>
            ...
            <View style={styles.contentFooterTexts}>
              ...
              >
                mateusnasciment0    Uma boa viagem!
              </Text>
              <Text
          ...
          <View style={styles.contentFooter}>
            ...
            <View style={styles.contentFooterTexts}>
              <Text
                style={[styles.contentFooterText1, styles.contentFooterText]}
              >
                mateusnasciment0   Que saudades de uma boa piscina!
              </Text>
              <Text
                style={[styles.contentFooterText2, styles.contentFooterText]}
              >
